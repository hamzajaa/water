package com.example.waterbillingsystem.security.jwt;

import com.auth0.jwt.JWT;
import com.auth0.jwt.algorithms.Algorithm;
import com.example.waterbillingsystem.security.bean.User;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.example.waterbillingsystem.WaterBillingSystemApplication;
import com.example.waterbillingsystem.security.common.SecurityParams;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        UserService userService = WaterBillingSystemApplication.getCtx().getBean(UserService.class);
